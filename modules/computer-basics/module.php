...
$module_challenges = array(
  ...
  new challenge('explore-your-file-system-1.md', 'Explore Your File System', '32', '128'), # video needed
  new challenge('files-and-folders-1.md', 'Files and Folders', '98', '102'), # video needed
  new challenge('explore-your-file-system-2.md', 'Explore Your File System (Part 2)', '44', '213'), # video needed
  new challenge('files-and-folders-2.md', 'Files and Folders (Part 2)', '86', '216') # video needed
...
$module_videos = array(
  ...
  new video('j9EKn1rtUCY', 'Computer Directory (Folder) Structure'), # redo
  new video('mgWb3aWpAws', 'File Systems (an additional thought)'), # redo
