...
<html>
  <head>
    <title>Absolute Column Challenge</title>
  </head>
  <body>
    <div id="container">
      <div id="column"></div>
...
![](https://raw.github.com/christensenacademy/christensen-academy/master/modules/css-layouts/challenges/absolute-column-challenge.png)
