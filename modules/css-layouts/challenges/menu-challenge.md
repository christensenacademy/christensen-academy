...
Your challenge to write CSS so that the follow page looks like the picture below.
...
![](https://raw.github.com/christensenacademy/christensen-academy/master/modules/css-layouts/challenges/menu-challenge.png)